...
在 App 中设置电价后，系统才能计算用电成本和收益，并支持动态电价优化和 AI 模式等功能。
...
👉 更多并机配置与操作说明，请参阅 [并机说明](../hardware/technical-note/cluster.md)
...
支持多种界面语言切换，可选：简体中文、英语、法语、德语、意大利语、荷兰语。
