---
title: 快速上手
description: Indevolt储能设备安装与初次使用指南
---

# 快速上手

本文档适用于 SolidFlex 2000 / PowerFlex 2000 储能设备，介绍从开箱到首次投入使用的完整流程。内容包括安装前检查、设备安装、首次开机以及 App 添加设备等步骤。
...
:::info
当主机发生故障时，系统将在15分钟内自动尝试恢复。若恢复失败，需由专业售后人员处理。经专业售后确认符合要求后，系统功能方可恢复。
:::
